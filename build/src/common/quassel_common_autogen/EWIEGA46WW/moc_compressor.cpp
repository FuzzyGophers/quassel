...
#include "../../../../../src/common/compressor.h"
...
template <> constexpr inline auto Compressor::qt_create_metaobjectdata<qt_meta_tag_ZN10CompressorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'error'
        QtMocHelpers::SignalData<void(Compressor::Error)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
        // Signal 'error'
...
void Compressor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->error((*reinterpret_cast< std::add_pointer_t<Compressor::Error>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Compressor::*)()>(_a, &Compressor::readyRead, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Compressor::*)(Compressor::Error )>(_a, &Compressor::error, 1))
            return;
    }
}
...
// SIGNAL 0
void Compressor::readyRead()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Compressor::error(Compressor::Error _t1)
{
